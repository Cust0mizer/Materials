Команда которая позволяет сделать выборку по определенным условиям, к примеру мы можем выбрать все объекты которые больше или меньше определенного значения в листе.
